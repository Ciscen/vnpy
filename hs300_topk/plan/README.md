...
2. **Download data** (cached locally)
   ```bash
   python -m hs300_topk.data.download_data
   ```
...
4. **Back‑test the strategy**
   ...
   ```
5. **Deploy in live trading** – load `hs300_topk.strategy.HS300Top10Strategy` into your vnpy CTA engine.
...
Feel free to adjust hyper‑parameters in `hs300_topk/model/trainer.py` or the strategy file.
